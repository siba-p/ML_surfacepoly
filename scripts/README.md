...
|---prepare_canonical_data.py # Loads and reshapes canonical surface, polymer, and PMF data (DelF)
|---prepare_data.py # Defines data augmentation, canonicalization, and splitting
|---prepare_model_data.py # Main wrapper: calls canonical prep, augmentation
